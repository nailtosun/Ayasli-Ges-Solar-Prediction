...
function TestCfm(f){
if (confirm("%#LABEL_START_TESTMAIL#")) {
window.location.href="testnet?2"
}}
</script>
</head>
<body>
<div id="rap">
	<div id="inhalt">
		...
		<div id="contentright">
			<h1>%#MENU_CONFIGURATION# // %#MENU_EXPERT# // %#MENU_EMAIL#</h1>
			<form method="post" action="email_post.html">
				<strong>%#LABEL_EMAIL_SETTINGS#</strong><br />
				<br />
				...
				<br />
				<br />
				<strong>%#LABEL_EMAIL_NOTIFIC#</strong><br />
				<br />
				<table width="500" border="0" cellspacing="0" cellpadding="0" class="form_table">
					<tr>
						<td></td>
					...
					<tr>
						...
						<td><input name="time" id="time" maxlength="5" type="text" class="einzeiligshort" value="%s" /></td>
					</tr>
					<tr>
						<td></td>
